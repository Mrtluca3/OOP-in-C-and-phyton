...
void f3(double* x) {
  cout << "f3: input value of x = " << *x << endl;
  *x = 140000;
  cout << "f3: change value of x in f3() using pointer. x = " << *x << endl;
}


int main() {

  double a = 14.; // define a
  ...
  emptyLine();
  cout << "main: before calling f3, a = " << a<< endl;
  f3(&a);  // void function
  cout << "main: after calling f3, a = " << a << endl;
